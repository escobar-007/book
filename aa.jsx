...
//           style={{ color: "#7a7060", fontSize: "0.78rem" }}
//         >
//           {author.years}
//         </p>
...
//   // ✅ id bo'lsa Link, bo'lmasa oddiy div
//   return author.id ? (
//     <Link to={`/adiblar/${author.id}`} style={{ textDecoration: "none" }}>
//       {card}
//     </Link>
//   ) : (
//     <div>{card}</div>
...
//   return (
//     <>
//       <section style={{ minHeight: "100vh", padding: "3rem 2rem" }}>
...
//             <AuthorCard key={author.name} author={author} /> // ✅ o'zgarmadi
//           ))}
//         </div>
//       </section>
//     </>
